...
var subbutton = document.getElementById("subme");
...
var displayconsole = function(){
	...
	newpost.category = document.getElementById("selectmenu2").value;
	newpost.date = document.getElementById("date").value;
	newpost.signi = document.getElementById("slider1").value;
	newpost.content = document.getElementById("textarea1").value;
